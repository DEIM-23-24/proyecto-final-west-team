...
void applyRimLighting(inout float4 albedo, inout float3 rimLightEmission)
{
    ...
    float rimWidth = lerp( - .05, 1, (0.758 /*_RimWidth*/));
    #ifdef POI_AUDIOLINK
    ...
    #endif
    #if defined(PROP_RIMTEX) || !defined(OPTIMIZER_ENABLED)
        rimColor = POI2D_SAMPLER_PAN(_RimTex, _MainTex, poiMesh.uv[(0.0 /*_RimTexUV*/)], float4(0,0,0,0)) * float4(0,0,0,0.9803922);
    #else
        rimColor = float4(0,0,0,0.9803922);
    #endif
    ...
    rim = 1 - smoothstep(min((0.663 /*_RimSharpness*/), rimWidth), rimWidth, viewDotNormal);
    rim *= float4(0,0,0,0.9803922).a * rimColor.a * rimMask;
    rimLightEmission = rim * lerp(albedo, rimColor, (0.827 /*_RimLightColorBias*/)) * rimStrength;
    albedo.rgb = lerp(albedo.rgb, lerp(albedo.rgb, rimColor, (0.827 /*_RimLightColorBias*/)) + lerp(albedo.rgb, rimColor, (0.827 /*_RimLightColorBias*/)) * rimBrighten, rim);
}
#endif
