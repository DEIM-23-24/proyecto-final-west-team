    ...
    void applyMatcap(inout float4 finalColor, inout float3 matcapEmission)
    {
        ...
        half2 matcapUV = half2(dot(worldViewRight, poiMesh.normals[(1.0 /*_MatcapNormal*/)]), dot(worldViewUp, poiMesh.normals[(1.0 /*_MatcapNormal*/)])) * (0.157 /*_MatcapBorder*/) + 0.5;
        #if defined(PROP_MATCAP) || !defined(OPTIMIZER_ENABLED)
            matcap = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap)) * float4(1,1,1,1);
        #else
            matcap = float4(1,1,1,1);
        #endif
        matcap.rgb *= (0.0 /*_MatcapIntensity*/);
        #if defined(PROP_MATCAPMASK) || !defined(OPTIMIZER_ENABLED)
        ...
        blendMatcap(finalColor, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), matcap, matcapMask, matcapEmission, (0.0 /*_MatcapEmissionStrength*/)
        #ifdef POI_LIGHTING
