...
void poiBRDF(inout float4 finalColor, const float4 finalColorBeforeLighting)
{
    ...
    float metallic = metallicGlossMap.r * (0.884 /*_BRDFMetallic*/);
    float reflectance = metallicGlossMap.g * (0.0 /*_BRDFReflectance*/);
    float roughness = max(1 - ((1.0 /*_BRDFGlossiness*/) * metallicGlossMap.a), getGeometricSpecularAA(poiMesh.normals[1]));
