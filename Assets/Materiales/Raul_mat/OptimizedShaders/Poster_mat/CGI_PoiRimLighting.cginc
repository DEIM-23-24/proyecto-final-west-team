...
void applyRimLighting(inout float4 albedo, inout float3 rimLightEmission)
{
    ...
    float rimWidth = lerp( - .05, 1, (0.205 /*_RimWidth*/));
    #ifdef POI_AUDIOLINK
    ...
    rimLightEmission = rim * lerp(albedo, rimColor, (0.575 /*_RimLightColorBias*/)) * rimStrength;
    albedo.rgb = lerp(albedo.rgb, lerp(albedo.rgb, rimColor, (0.575 /*_RimLightColorBias*/)) + lerp(albedo.rgb, rimColor, (0.575 /*_RimLightColorBias*/)) * rimBrighten, rim);
}
#endif
