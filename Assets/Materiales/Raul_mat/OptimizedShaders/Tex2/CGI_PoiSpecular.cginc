...
float3 calculateSpecular(in float4 albedo)
{
    ...
    half metallic = POI2D_SAMPLER_PAN(_SpecularMetallicMap, _MainTex, poiMesh.uv[(0.0 /*_SpecularMetallicMapUV*/)], float4(0,0,0,0)).r * (0.0 /*_SpecularMetallic*/);
    ...
    if ((0.0 /*_SpecularMaxBrightness*/))
    {
        specularLightColor = clamp(poiLight.color, 0, (0.0 /*_SpecularMaxBrightness*/));
    }
    #ifdef FORWARD_ADD_PASS
    ...
    if ((1.0 /*_SpecularType*/) == 1) // Realistic
    {
        ...
        finalSpecular += calculateNewSpecular(specularMap.rgb, (1.0 /*_SmoothnessFrom*/), realisticAlbedo, float4(1,1,1,1), metallic, (1.0 /*_SpecularSmoothness*/) * specularMap.a, poiLight.dotNH, poiLight.dotLH, specularLightColor, attenuation);
    }
    ...
    if ((1.0 /*_SpecularType*/) == 4)
    {
        ...
        finalSpecular += toonAnisoSpecular((0.0 /*_SpecWhatTangent*/), (0.0 /*_AnisoUseTangentMap*/), poiLight.direction, poiLight.halfDir, specularMap, poiLight.nDotL, (0.95 /*_SpecularToonStart*/), (1.0 /*_SpecularToonEnd*/), float4(1,1,1,1), albedo, metallic, jitter, (0.0 /*_SpecularAnisoJitterMirrored*/), packedTangentMap);
        ...
        {
            finalSpecular += calculateToonSpecular(albedo, poiMesh.uv[0], float4(0.25,0.3,0,1), metallic, (1.0 /*_SmoothnessFrom*/), specularMap, specularLightColor, poiMesh.normals[(1.0 /*_SpecularNormal*/)], poiLight.halfDir, poiLight.attenuation);
        ...
        if ((1.0 /*_SpecularType*/) == 3) // anisotropic
        {
            ...
            jitter += (0.0 /*_Spec1Offset*/);
            float4 packedTangentMap = POI2D_SAMPLER_PAN(_AnisoTangentMap, _MainTex, poiMesh.uv[(0.0 /*_AnisoTangentMapUV*/)], float4(0,0,0,0));
            finalSpecular += AnisotropicSpecular((0.0 /*_SpecWhatTangent*/), (0.0 /*_AnisoUseTangentMap*/), (1.0 /*_SpecularSmoothness*/), (0.0 /*_Spec2Smoothness*/), (1.0 /*_AnisoSpec1Alpha*/), (1.0 /*_AnisoSpec2Alpha*/), float4(1,1,1,1), metallic, specularMap, specularLightColor, poiLight.direction, poiLight.halfDir, poiLight.nDotL, jitter, packedTangentMap, albedo);
            finalSpecular *= float4(1,1,1,1);
            finalSpecular *= attenuation;
        }
    #endif
        ...
        for (int index = 0; index < 4; index++)
        {
            ...
            if ((1.0 /*_SpecularType*/) == 1) // Realistic
            {
                finalSpecular += calculateNewSpecular(specularMap.rgb, (1.0 /*_SmoothnessFrom*/), realisticAlbedo, float4(1,1,1,1), metallic, (1.0 /*_SpecularSmoothness*/) * specularMap.a, poiLight.vDotNH[index], poiLight.vDotLH[index], poiLight.vColor[index], poiLight.vAttenuationDotNL[index]);
            }
        }
    #endif
