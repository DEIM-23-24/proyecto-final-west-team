...
v2f vert(appdata v)
{
	...
	float3 offset = o.normal * ((0.0 /*_LineWidth*/) * (1.0 /*_commentIfZero_EnableOutlinePass*/) / 100) * outlineMask * distanceOffset;
	
	if ((4.0 /*_OutlineMode*/) == 2)
	{
