...
UnityLight CreateLight(float3 normal, fixed detailShadowMap)
{
    ...
    light.color = saturate(_LightColor0.rgb * lerp(1, poiLight.attenuation, (0.08 /*_AttenuationMultiplier*/)) * detailShadowMap);
...
float FadeShadows(float attenuation)
{
            ...
            attenuation = lerp(1, poiLight.attenuation, (0.08 /*_AttenuationMultiplier*/));
        #endif
...
void ApplySubtractiveLighting(inout UnityIndirect indirectLight)
{
        ...
        poiLight.attenuation = FadeShadows(lerp(1, poiLight.attenuation, (0.08 /*_AttenuationMultiplier*/)));
...
void calculateBasePassLightMaps()
{
        ...
        float bw_directLighting = (((poiLight.nDotL * 0.5 + 0.5) * bw_lightColor * lerp(1, poiLight.attenuation, (0.08 /*_AttenuationMultiplier*/))) + dot(ShadeSH9Normal(poiMesh.normals[1]), grayscale_vector));
        ...
        switch((0.0 /*_LightingRampType*/))
        {
            case 0: // Ramp Texture
            {
                poiLight.rampedLightMap = lerp(1, UNITY_SAMPLE_TEX2D(_ToonRamp, poiLight.lightMap + (-0.41 /*_ShadowOffset*/)).rgb, shadowStrength.r);
        ...
        {
            poiLight.directLighting = (_LightColor0.rgb) * saturate(RTWrapFunc(poiLight.nDotL, (0.0 /*_LightingWrappedWrap*/), (0.0 /*_LightingWrappedNormalization*/))) * detailShadow * lerp(1, poiLight.attenuation, (0.08 /*_AttenuationMultiplier*/));
