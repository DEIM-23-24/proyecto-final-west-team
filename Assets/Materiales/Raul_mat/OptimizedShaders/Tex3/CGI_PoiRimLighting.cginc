...
void applyRimLighting(inout float4 albedo, inout float3 rimLightEmission)
{
        ...
        float rimNoise = 0;
    #endif
    rimNoise = (rimNoise - .5) * (0.041 /*_RimWidthNoiseStrength*/);
    ...
    float rimWidth = lerp( - .05, 1, (0.954 /*_RimWidth*/));
    #ifdef POI_AUDIOLINK
    ...
    rim = 1 - smoothstep(min((0.895 /*_RimSharpness*/), rimWidth), rimWidth, viewDotNormal);
    rim *= float4(0,0,0,1).a * rimColor.a * rimMask;
    rimLightEmission = rim * lerp(albedo, rimColor, (0.535 /*_RimLightColorBias*/)) * rimStrength;
    albedo.rgb = lerp(albedo.rgb, lerp(albedo.rgb, rimColor, (0.535 /*_RimLightColorBias*/)) + lerp(albedo.rgb, rimColor, (0.535 /*_RimLightColorBias*/)) * rimBrighten, rim);
}
#endif
